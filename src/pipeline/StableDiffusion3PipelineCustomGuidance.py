...
class StableDiffusion3PipelineCustomGuidance(StableDiffusion3Pipeline):
    ...
    def __call__(
        ...
        r"""
        Run SD3 inference with custom guidance.

        Compared to the base StableDiffusion3Pipeline, the guidance step is
        modified via `_apply_guidance`, enabling plug-and-play test-time
        control methods.
